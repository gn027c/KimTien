  ...
  <div className="min-h-screen flex flex-col items-center bg-gray-50 py-10 px-4">
    <div className="max-w-2xl w-full bg-white rounded-xl shadow p-6 md:p-10">
      ...
      <div className="space-y-8 text-gray-700 text-base">
        <section>
          <h2 className="text-xl font-semibold text-blue-600 mb-2">1. Chính sách bảo mật thông tin</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-blue-600 mb-2">2. Chính sách đổi trả & hoàn tiền</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-blue-600 mb-2">3. Chính sách vận chuyển & giao hàng</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-xl font-semibold text-blue-600 mb-2">4. Chính sách thanh toán</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-xl font-semibold text-blue-600 mb-2">5. Hỗ trợ khách hàng</h2>
          <ul className="list-disc pl-5 space-y-1">
